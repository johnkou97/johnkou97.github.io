...
Cover Image by <a href="https://unsplash.com/@grakozy?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Greg Rakozy</a> on <a href="https://unsplash.com/photos/silhouette-photography-of-person-oMpAz-DN-9I?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>
<br>
<br>
...
$$ P*{\text{e}} = K*{\text{ER}} \left( \frac{\rho}{\mu*e} \right)^{4/3} \quad \text{(extreme relativistic degenerate electron gas)}, \quad P*{\text{rad}} = \frac{a T^4}{3} \quad \text{(radiation pressure)},$$
